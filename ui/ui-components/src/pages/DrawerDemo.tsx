...
export const DrawerDemo: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-8 text-gray-900">Drawer Component Demo</h1>

      <div className="space-y-8">
        <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Drawer Positions</h2>
          ...
          >
            <div className="space-y-4">
              <p className="text-gray-600">This drawer slides in from the right side.</p>
              <div className="space-y-2">
          ...
          <Drawer
            ...
            position="bottom"
          >
            <p className="text-gray-600">This drawer slides in from the bottom.</p>
          </Drawer>
        </section>

        <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Drawer with Footer</h2>
