    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-2xl font-semibold mb-4">Interactive Validation</h2>
          ...
          <section className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-2xl font-semibold mb-4">All Sizes with Labels</h2>
            <div className="space-y-4 max-w-md">
              <Input size="sm" label="Small" placeholder="Small input with label" />
              <Input size="md" label="Medium" placeholder="Medium input with label" />
              <Input size="lg" label="Large" placeholder="Large input with label" />
            </div>
          </section>
        </div>
      </div>
